...
* Currently the repository covers popular sorting algorithm i.e.:
   1. Selection Sort
   2. Insertion Sort
   3. Shell Sort
   4. Bubble Sort
   ...
   7. Quick Sort
   8. Power Sort
* It prvides useful tools and resources: 
...
* It prvides an interactive feedback and discussion option.
  ...
  - Please use [discussions](https://github.com/ia-dev/algorithms/discussions) to ask or answer questions.
